...
class DuplicateDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(
        'The file "$filename" already exists in the registry. What would you like to do?',
      ),
      actions: [
        TextButton(
        ...
        TextButton(
          onPressed: () =>
              Navigator.of(context).pop(DuplicateResolution.rename),
          child: const Text('Rename'),
        ),
        ElevatedButton(
          onPressed: () =>
              Navigator.of(context).pop(DuplicateResolution.overwrite),
