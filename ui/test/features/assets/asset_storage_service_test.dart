...
void main() {
  ...
  group('AssetStorageService', () {
    ...
    test('importAsset should copy file to assets directory', () async {
      ...
      await sourceFile.writeAsBytes([0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0, 1, 0, 0, 0, 1, 8, 2, 0, 0, 0, 144, 119, 83, 222, 0, 0, 0, 0, 73, 69, 78, 68, 174, 66, 96, 130]);
    ...
    test('generateUniqueFilename should return new name if collision exists', () async {
      final assetsDir = Directory('${tempDir.path}/Assets');
      await assetsDir.create(recursive: true);
    ...
    test('renameAsset should rename file on disk and return updated asset', () async {
      final assetsDir = Directory('${tempDir.path}/Assets');
      await assetsDir.create(recursive: true);
