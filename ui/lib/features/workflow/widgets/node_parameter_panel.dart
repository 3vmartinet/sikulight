          ...
          Expanded(
            child: ListView(
              children: [
                _InputPortsSection(
                  nodeId: nodeId,
                  ports: node.ports.where((p) => p.type == vnf.PortType.input).toList(),
                  onAdd: () => viewModel.addInputPort(nodeId),
                  onRemove: (portId) => viewModel.removeInputPort(nodeId, portId),
                ),
                const SizedBox(height: 16),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            OutlinedButton(
              onPressed: () => widget.onChanged((_value.round() - 1).clamp(-50, 50)),
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            const Text('Input Ports', style: TextStyle(fontWeight: FontWeight.bold)),
            IconButton(
